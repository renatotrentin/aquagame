...
<body>
        		...
        		<h5 class="text-center">Cadastre novas perguntas para o jogo.</h5>
               	...
               	<form class="form-horizontal" method="POST">
					...
					<div class="form-group">
					  ...
					  <div class="col-md-8">                     
					    <textarea placeholder="Digite sua pergunta..." rows="8" cols="12" class="form-control bordas" id="pergunta" name="pergunta"></textarea>
					  </div>
					</div>
    ...
    <br><br>
    <!-- Aprovar perguntas -->
	<h2 class="text-center cor">Aprovar Perguntas</h2>
	<h5 class="text-center">Aprove as perguntas dos usuários</h5>
		<?php $permissao->listagemPerguntas(); ?>
		<?php //$permissao->aprovarPergunta(); ?>
	<br><br>
